#!/usr/bin/env python3
"""
spartan-review: Full strict code review pipeline.

Runs all quality gates: ruff, ty, tests, bandit.
"""
...
def main() -> int:
    ...
    # Security
    all_passed &= run(["uv", "run", "bandit", "-r", "src/spartan_torch", "-ll"], "Bandit security")
